# How to contribute to the API Monitor Javascript Client project
...
3. Set this repo as the `upstream` repo `git remote add upstream git@github.com:davesag/api-monitor-client-js.git`
